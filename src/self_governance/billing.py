...
def report_usage_to_stripe(tenant_id: str, cost_usd: float, stripe_customer_id: str = None) -> None:
    ...
    if not stripe_customer_id:
        logger.warning("No stripe_customer_id found for tenant %s. Skipping.", tenant_id)
        return
